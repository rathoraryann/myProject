...
export function VideoGridItems({id, title, channel, views, postedAt, duration, thumbnailUrl, videoUrl}: VideoGridItemsProps){
    ...
    return (
        ...
        <div className="flex gap-2">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-secondary-text text-sm">{VIEW_FORMATTER.format(views)} Views {formatTimeAgo(postedAt)}
